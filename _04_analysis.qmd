...
Becuase of this, we decided to focus on home sale prices for the rest of our analysis.  For reference and comparison, we have also included (@fig-mortgage-affordability) which shows how housing payment affordability has dwindled in recent years, while rent has stayed relatively stable.
<br><br>
...
For a list of all results, see the table in the [Appendix](capstone.html#database-significant-coefficients)
...
### Interrupted Time Series as a kind of A/B Test When an A/B Test is Not an Option
...
Using the ARIMA function in the statsmodels.tsa.arima.model library, we obtained the following results:
