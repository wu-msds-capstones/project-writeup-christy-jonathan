...
fig.add_trace(go.Scatter(x=initial_county_data['date'], y=initial_county_data['monthly_housing_payment'], mode='lines', name='Monthly Median Mortgage P&I Payment'))
...
fig.update_layout(
    ...
    xaxis_title='Date',
    yaxis_title='Monthly Mortgage Payment<br>Monthly Affordable Housing Payment <br> (U.S. Dollars)',
)
