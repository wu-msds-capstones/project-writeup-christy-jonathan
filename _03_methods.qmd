...
We analyzed 36 counties in our dataset to identify which features have a significant association with the number 
...
![Feature Significance Representation in Oregon Home Sales](images/sig-feature-representation.png){#fig-feature-sig width=300}
...
Using variance_inflation_factor from the Statsmodels library, we were able to try all combinations of our remaining variables to find viable candidate
combinations to fit a linear model.
