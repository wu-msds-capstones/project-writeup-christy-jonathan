...
##### 2. Materials (Software and libraries) 

	1.  python v3.12.4	
	2.  sklearn	v1.5.1 for linear regression and random forest
	3.  statsmodels v0.14.1 for timeseries analysis
    4.  matplotlib v3.9.0 and plotly v5.23.0 for visualizations
    5.  pandas and numpy for data manipulation

##### 3. Data Exploration and Initial Analysis 


1.  scatter plots and correlation plots to look for highly correlated data - list the values used for significance
