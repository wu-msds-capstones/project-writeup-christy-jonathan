...
To align with the overarching objective of this project, which is to identify strategies that effectively balance housing demand with rising costs, we initiated our work with a thorough review of current approaches to addressing housing affordability. This review focused on identifying the core objectives of these strategies, such as expanding housing inventory, stabilizing rental prices, and improving access for low-income households. While all strategies aim to increase affordable housing, some prioritize boosting housing supply by encouraging new construction. The results, including the strategies, goals, and categories, are presented in the following table. 
